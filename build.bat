...
set Compiler_Flags=/nologo /W4 /wd4244 /wd4201 /Z7 /GS- /GR- /EHa- /Odi /MTd /fp:fast /FC /D_CRT_SECURE_NO_WARNINGS
set Lib_Files=user32.lib SDL2.lib SDL2_ttf.lib SDL2_image.lib SDL2_mixer.lib
