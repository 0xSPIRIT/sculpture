...
set Compiler_Flags=/nologo /diagnostics:column /W4 /WX /wd4389 /wd4244 /Zi /GR- /EHa- /Odi /MTd /FC /Fo:"obj\\" /D_CRT_SECURE_NO_WARNINGS /DALASKA_DEBUG /DALASKA_USE_SOFTWARE_RENDERER
