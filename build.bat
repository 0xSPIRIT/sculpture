...
set Compiler_Flags=/nologo /W4 /wd4244 /wd4201 /Zi /GS- /GR- /EHa- /Odi /MDd /FC /Fo:"obj\\" /D_CRT_SECURE_NO_WARNINGS
set Linker_Flags=user32.lib SDL2.lib SDL2_ttf.lib SDL2_image.lib SDL2_mixer.lib
